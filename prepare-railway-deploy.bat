...
echo Ce script va préparer votre projet pour le déploiement sur Railway.
echo.
...
if not exist .git (
    ...
    echo git add .
    echo git commit -m "Mise à jour pour déploiement Railway"
...
echo 3. Connectez-vous sur Railway (https://railway.app)
echo 4. Créez un nouveau projet et liez-le à votre repository GitHub
echo 5. Suivez les instructions dans RAILWAY_DEPLOYMENT_GUIDE.md
echo.
pause
